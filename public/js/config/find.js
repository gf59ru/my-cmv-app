	...
	queries: [ // описание запросов поиска
		{
			...
			url: esriConfig.defaults.mapServiceBer, // ссылка на сервис карт
			layerIds: [0, 2, 3], // id слоёв в сервисе
			searchFields: ['DHHOLENAME', 'N', 'N'], // поля, по которым будет производиться поиск
